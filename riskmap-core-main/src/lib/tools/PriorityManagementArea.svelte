    ...
    const hazardConfigs = {
        ...
        flood: {
            ...
            indicators: [
                ...
                { id: 234, analysisIndicator: 'facility-shelter', icon: '↗', label: '민방위 대피시설 접근성 proxy', description: '중복 제거 후 개방 중인 민방위 대피시설 5,095개 실제 위치를 기준으로 계산한 400m 커널밀도 · 값이 높을수록 대피시설 접근성·적응역량이 높음', dimension: 'V', group: '적응역량', weight: 1, direction: 'negative', enabled: false, dataStatus: 'partial', sourceType: 'PostGIS-shelter-KDE-400m', supportedGridUnits: ['100m'], color: '#61958b' },
