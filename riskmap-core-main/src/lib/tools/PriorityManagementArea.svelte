    ...
    const hazardConfigs = {
        ...
        flood: {
            ...
            indicators: [
                ...
                { id: 234, analysisIndicator: 'facility-shelter', icon: '↗', label: '민방위 대피시설 밀도', description: '현재 적재본 5,147개 · 지역별 원자료 커버리지 확인 필요', dimension: 'V', group: '적응역량', weight: 1, direction: 'negative', enabled: true, dataStatus: 'partial', sourceType: 'PostGIS-facility-100m', supportedGridUnits: ['100m'], color: '#61958b' },
