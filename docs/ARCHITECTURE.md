...
| 기후적응실천권역 선정 지원도구 | 내부 | `http://127.0.0.1:4175/priority-management-area` |
| 폭염 기후적응실천권역 선정 | 내부, 수원 샘플 | `http://127.0.0.1:4175/priority-management-area/heatwave` |
| 홍수 기후적응실천권역 선정 | 내부, 준비 중 | `http://127.0.0.1:4175/priority-management-area/flood` |
...
5. 기후적응실천권역 도구의 메인·폭염·홍수 지도는 `SelectedRegionMap.svelte`를 함께 사용합니다.
...
분리합니다. 기후적응실천권역 선정 도구와 사업소관부서 도구는 같은 API에 `SIG_CD`,
